...
// Bot Information
global.info = {
  nomerbot: '6285603404603', // nomor bot mu
  pairingNumber: '6285603404603', // penting!! wajib ganti jadi nomor bot mu 
  nameown: 'OwwenmeraZa.ID',
  nomerown: '6285603404603',
  token: 'VynaaAI4m2n1o', // Token harus diisi agar bot dapat berjalan
  packname: 'sticker by',
  author: 'OwwenmeraZa.ID',
  namebot: 'Vynaa AI 10.21',
  wm: 'made by OwwenmeraZa.ID',
  stickpack: 'OwwenmeraZa.ID',
  stickauth: 'S U B S C R I B E',
};

global.wait = 'TUNGGU-SEBENTAR'; // Pesan saat menunggu
global.maxwarn = 5;
...
global.url = {
  ...
  sig: '',
  sgh: '',
  sgc: 'https://whatsapp.com/channel/0029VauPJAhEVccHHykhFR1U',
};
